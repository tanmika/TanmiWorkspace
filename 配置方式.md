...
**配置权限**：编辑 `~/.claude/settings.json`，在 `permissions.allow` 数组中添加：
...
> 💡 使用 `mcp__tanmi-workspace` 即可授权该服务器的所有工具，无需逐个列出。
...
2. 访问 Web 界面（http://localhost:3001）查看工作区可视化
