...
- tanmi_help({ topic: "phases" }) → 获取工作流阶段指南
 ...
 */
export type HelpTopic = "overview" | "workflow" | "tools" | "start" | "resume" | "session_restore" | "blocked" | "split" | "complete" | "progress" | "guide" | "docs" | "reopen" | "dispatch" | "status" | "server" | "phases" | "signal" | "workflow_constraints" | "workflow_errors" | "all";
